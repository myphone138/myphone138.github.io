...
# 定义原件和签名文件的路径
$originalPath = [System.IO.Path]::GetFullPath("K:\完整性校验_6FEC A20A@A\files\origin")  # 改为根目录，支持递归搜索
$signaturePath = [System.IO.Path]::GetFullPath("K:\完整性校验_6FEC A20A@A\files\sign")
